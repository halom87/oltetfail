/*****< hidapi.h >*************************************************************/
/*      Copyright 2002 - 2012 Stonestreet One.                                */
/*      All Rights Reserved.                                                  */
/*                                                                            */
...
#define SDP_ASSIGN_HID_PROTOCOL_UUID_16(_x)             ASSIGN_UUID_16((_x), 0x00, 0x11)
...
#define SDP_ASSIGN_HID_PROTOCOL_UUID_32(_x)             ASSIGN_UUID_32((_x), 0x00, 0x00, 0x00, 0x11)
...
#define SDP_ASSIGN_HID_PROTOCOL_UUID_128(_x)            ASSIGN_UUID_128((_x), 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0x80, 0x5F, 0x9B, 0x34, 0xFB)
   ...
   /* parameter which is the UUID_16_t variable that is to receive the  */
   /* HID_PROTOCOL_UUID_16 Constant value.                              */
#define SDP_ASSIGN_HID_PROFILE_UUID_16(_x)              ASSIGN_UUID_16((_x), 0x11, 0x24)
   ...
   /* parameter which is the UUID_32_t variable that is to receive the  */
   /* HID_PROTOCOL_UUID_32 Constant value.                              */
#define SDP_ASSIGN_HID_PROFILE_UUID_32(_x)              ASSIGN_UUID_32((_x), 0x00, 0x00, 0x11, 0x24)
   ...
   /* parameter which is the UUID_128_t variable that is to receive the */
   /* HID_PROTOCOL_UUID_128 Constant value.                             */
#define SDP_ASSIGN_HID_PROFILE_UUID_128(_x)             ASSIGN_UUID_128((_x), 0x00, 0x00, 0x11, 0x24, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0x80, 0x5F, 0x9B, 0x34, 0xFB)

   /* Defines the Profile Version Number used within the SDP Record for */
   /* Human Interface Device Profile Servers.                           */
#define HID_PROFILE_VERSION                                       (0x0100)
...
BTPSAPI_DECLARATION int BTPSAPI HID_Un_Register_Server(unsigned int BluetoothStackID);
   ...
   /* NumberDescriptors, defines the number of HID Descriptor           */
   /* structures found in the array specified by the next parameter, the*/
