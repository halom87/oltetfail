...
#define HTS_ASSIGN_HTS_SERVICE_UUID_16(_x)               ASSIGN_UUID_16(*((UUID_16_t *)(_x)), 0x09, 0x18)
...
#define HTS_COMPARE_HTS_SERVICE_UUID_TO_UUID_16(_x)      COMPARE_UUID_16_TO_CONSTANT((_x), 0x09, 0x18)

   /* The following defines the Health Thermometer Service UUID that is */
   /* used when building the HTS Service Table.                         */
#define HTS_SERVICE_UUID_CONSTANT                        { 0x09, 0x18 }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define HTS_ASSIGN_TEMPERATURE_MEASUREMENT_UUID_16(_x)   ASSIGN_UUID_16((_x), 0x1C, 0x2A)
   ...
   /* UUID.                                                             */
#define HTS_COMPARE_HTS_TEMPERATURE_MEASUREMENT_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x1C, 0x2A)

   /* The following defines the HTS Temperature Measurement             */
   /* Characteristic UUID that is used when building the HTS Service    */
   /* Table.                                                            */
#define HTS_TEMPERATURE_MEASUREMENT_CHARACTERISTIC_UUID_CONSTANT    { 0x1C, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define HTS_ASSIGN_TEMPERATURE_TYPE_UUID_16(_x) ASSIGN_UUID_16((_x), 0x1D, 0x2A)
...
#define HTS_COMPARE_HTS_TEMPERATURE_TYPE_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x1D, 0x2A)

   /* The following defines the HTS Temperature Type Characteristic UUID*/
   /* that is used when building the HTS Service Table.                 */
#define HTS_TEMPERATURE_TYPE_CHARACTERISTIC_UUID_CONSTANT    { 0x1D, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define HTS_ASSIGN_INTERMEDIATE_TEMPERATURE_UUID_16(_x) ASSIGN_UUID_16((_x), 0x1E, 0x2A)
   ...
   /* UUID.                                                             */
#define HTS_COMPARE_HTS_INTERMEDIATE_TEMPERATURE_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x1E, 0x2A)

   /* The following defines the HTS Intermediate Temperature            */
   /* Characteristic UUID that is used when building the HTS Service    */
   /* Table.                                                            */
#define HTS_INTERMEDIATE_TEMPERATURE_CHARACTERISTIC_UUID_CONSTANT    { 0x1E, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define HTS_ASSIGN_MEASUREMENT_INTERVAL_UUID_16(_x) ASSIGN_UUID_16((_x), 0x21, 0x2A)
   ...
   /* UUID.                                                             */
#define HTS_COMPARE_HTS_MEASUREMENT_INTERVAL_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x21, 0x2A)

   /* The following defines the HTS Measurement Interval Characteristic */
   /* UUID that is used when building the HTS Service Table.            */
#define HTS_MEASUREMENT_INTERVAL_CHARACTERISTIC_UUID_CONSTANT    { 0x21, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define HTS_ASSIGN_VALID_RANGE_DESCRIPTOR_UUID_16(_x)    ASSIGN_UUID_16((_x), 0x06, 0x29)
   ...
   /* UUID.                                                             */
#define HTS_COMPARE_HTS_VALID_RANGE_DESCRIPTOR_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x06, 0x29)

   /* The following defines the HTS Valid Range Descriptor UUID that is */
   /* used when building the HTS Service Table.                         */
#define HTS_VALID_RANGE_DESCRIPTOR_UUID_CONSTANT         { 0x06, 0x29 }
...
#define HTS_CLIENT_CHARACTERISTIC_CONFIGURATION_VALUE_LENGTH (WORD_SIZE)
