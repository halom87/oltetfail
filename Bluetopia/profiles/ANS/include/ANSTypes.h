...
#define ANS_ASSIGN_ANS_SERVICE_UUID_16(_x)               ASSIGN_UUID_16(*((UUID_16_t *)(_x)), 0x11, 0x18)
...
#define ANS_COMPARE_ANS_SERVICE_UUID_TO_UUID_16(_x)      COMPARE_UUID_16_TO_CONSTANT((_x), 0x11, 0x18)

   /* The following defines the Phone Alert Status Service UUID that is */
   /* used when building the ANS Service Table.                         */
#define ANS_SERVICE_UUID_CONSTANT                        { 0x11, 0x18 }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define ANS_ASSIGN_SUPORTED_NEW_ALERT_CATEGORY_UUID_16(_x) ASSIGN_UUID_16((_x), 0x47, 0x2A)
...
#define ANS_COMPARE_ANS_SUPORTED_NEW_ALERT_CATEGORY_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x47, 0x2A)

   /* The following defines the ANS Supported New Alert Category        */
   /* Characteristic UUID that is used when building the ANS Service    */
   /* Table.                                                            */
#define ANS_SUPORTED_NEW_ALERT_CATEGORY_CHARACTERISTIC_UUID_CONSTANT { 0x47, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define ANS_ASSIGN_NEW_ALERT_UUID_16(_x)                 ASSIGN_UUID_16((_x), 0x46, 0x2A)
...
#define ANS_COMPARE_ANS_NEW_ALERT_UUID_TO_UUID_16(_x)    COMPARE_UUID_16_TO_CONSTANT((_x), 0x46, 0x2A)

   /* The following defines the ANS New Alert Characteristic UUID that  */
   /* is used when building the ANS Service Table.                      */
#define ANS_NEW_ALERT_CHARACTERISTIC_UUID_CONSTANT       { 0x46, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define ANS_ASSIGN_SUPPORTED_UNREAD_ALERT_CATEGORY_UUID_16(_x) ASSIGN_UUID_16((_x), 0x48, 0x2A)
...
#define ANS_COMPARE_ANS_SUPPORTED_UNREAD_ALERT_CATEGORY_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x48, 0x2A)

   /* The following defines the ANS Supported Unread Alert Category     */
   /* Characteristic UUID that is used when building the ANS Service    */
   /* Table.                                                            */
#define ANS_SUPPORTED_UNREAD_ALERT_CATEGORY_CHARACTERISTIC_UUID_CONSTANT { 0x48, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define ANS_ASSIGN_UNREAD_ALERT_STATUS_UUID_16(_x)       ASSIGN_UUID_16((_x), 0x45, 0x2A)
...
#define ANS_COMPARE_ANS_UNREAD_ALERT_STATUS_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x45, 0x2A)

   /* The following defines the ANS Unread Alert Status Characteristic  */
   /* UUID that is used when building the ANS Service Table.            */
#define ANS_UNREAD_ALERT_STATUS_CHARACTERISTIC_UUID_CONSTANT { 0x45, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define ANS_ASSIGN_CONTROL_POINT_UUID_16(_x)             ASSIGN_UUID_16((_x), 0x44, 0x2A)
...
#define ANS_COMPARE_ANS_CONTROL_POINT_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x44, 0x2A)

   /* The following defines the ANS Control Point Characteristic UUID   */
   /* that is used when building the ANS Service Table.                 */
#define ANS_CONTROL_POINT_CHARACTERISTIC_UUID_CONSTANT    { 0x44, 0x2A }

   /* The following MACRO is a utility MACRO that assigns the Client    */
   /* Characteristic Configuration Descriptor 16 bit UUID to the        */
   /* specified UUID_16_t variable.  This MACRO accepts one parameter   */
   /* which is the UUID_16_t variable that is to receive the Client     */
   /* Characteristic Configuration Descriptor UUID Constant value.      */
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define ANS_ASSIGN_CLIENT_CHARACTERISTIC_CONFIGURATION_UUID_16(_x) ASSIGN_UUIS_16((_x), 0x02, 0x29)

   /* The following MACRO is a utility MACRO that exist to compare a    */
   /* UUID 16 to the defined Client Characteristic Configuration UUID in*/
   /* UUID16 form.  This MACRO only returns whether the UUID_16_t       */
   /* variable is equal to the Client Characteristic Configuration UUID */
   /* (MACRO returns boolean result) NOT less than/greater than.  The   */
   /* first parameter is the UUID_16_t variable to compare to the Client*/
   /* Characteristic Configuration UUID.                                */
#define ANS_COMPARE_CLIENT_CHARACTERISTIC_CONFIGURATION_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x02, 0x29)

   /* The following defines the Client Characteristic Configuration     */
   /* Descriptor UUID that is used when building the ANS Service Table. */
#define ANS_CLIENT_CHARACTERISTIC_CONFIGURATION_UUID_CONSTANT { 0x02, 0x29 }
...
#define ANS_SUPPORTED_UNREAD_ALERT_CATEGORY_VALUE_LENGTH             (WORD_SIZE)
   ...
   /* The following defines the length of the Client Configuration      */
   /* Descriptor value.                                                 */
#define ANS_CLIENT_CONFIGURATION_DESCRIPTOR_LENGTH                   (WORD_SIZE)
