...
#define PASS_ASSIGN_PASS_SERVICE_UUID_16(_x)             ASSIGN_UUID_16(*((UUID_16_t *)(_x)), 0x0E, 0x18)
...
#define PASS_COMPARE_PASS_SERVICE_UUID_TO_UUID_16(_x)    COMPARE_UUID_16_TO_CONSTANT((_x), 0x0E, 0x18)

   /* The following defines the Phone Alert Status Service UUID that is */
   /* used when building the PASS Service Table.                        */
#define PASS_SERVICE_UUID_CONSTANT                       {0x0E, 0x18}
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define PASS_ASSIGN_ALERT_STATUS_UUID_16(_x)              ASSIGN_UUID_16((_x), 0x3F, 0x2A)
...
#define PASS_COMPARE_PASS_ALERT_STATUS_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x3F, 0x2A)

   /* The following defines the PASS Alert Status Characteristic UUID   */
   /* that is used when building the PASS Service Table.                */
#define PASS_ALERT_STATUS_CHARACTERISTIC_UUID_CONSTANT   {0x3F, 0x2A}
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define PASS_ASSIGN_RINGER_SETTING_UUID_16(_x)           ASSIGN_UUID_16((_x), 0x41, 0x2A)
...
#define PASS_COMPARE_PASS_RINGER_SETTING_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x41, 0x2A)

   /* The following defines the PASS Alert Status Characteristic UUID   */
   /* that is used when building the PASS Service Table.                */
#define PASS_RINGER_SETTING_CHARACTERISTIC_UUID_CONSTANT {0x41, 0x2A}
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define PASS_ASSIGN_RINGER_CONTROL_POINT_UUID_16(_x)     ASSIGN_UUID_16((_x), 0x40, 0x2A)
   ...
   /* UUID.                                                             */
#define PASS_COMPARE_PASS_RINGER_CONTROL_POINT_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x40, 0x2A)

   /* The following defines the PASS Alert Status Characteristic UUID   */
   /* that is used when building the PASS Service Table.                */
#define PASS_RINGER_CONTROL_POINT_CHARACTERISTIC_UUID_CONSTANT {0x40, 0x2A}
   ...
   /* * NOTE * The UUID will be assigned into the UUID_16_t variable in */
   /*          Little-Endian format.                                    */
#define PASS_ASSIGN_CLIENT_CHARACTERISTIC_CONFIGURATION_UUID_16(_x) ASSIGN_UUIS_16((_x), 0x02, 0x29)
...
#define PASS_COMPARE_CLIENT_CHARACTERISTIC_CONFIGURATION_UUID_TO_UUID_16(_x) COMPARE_UUID_16_TO_CONSTANT((_x), 0x02, 0x29)

   /* The following defines the Client Characteristic Configuration     */
   /* Descriptor UUID that is used when building the PASS Service Table.*/
#define PASS_CLIENT_CHARACTERISTIC_CONFIGURATION_UUID_CONSTANT {0x02, 0x29}
...
#define PASS_RINGER_SETTING_VALUE_LENGTH                 (BYTE_SIZE)
   ...
   /* The following defines the length of a Client Characteristic       */
   /* Configuration Descriptor.                                         */
#define PASS_CLIENT_CONFIGURATION_DESCRIPTOR_LENGTH      (WORD_SIZE)
