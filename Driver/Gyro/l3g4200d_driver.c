...
{
	L3G4200D_WriteReg(L3G4200D_CTRL_REG2,0x00); //No HPF filter
	L3G4200D_WriteReg(L3G4200D_CTRL_REG3,0x00); //No Interrupt
	L3G4200D_WriteReg(L3G4200D_CTRL_REG4,0b10000000); //Block Data update,Little endian,  250dps
...
{
	I2C_BufferRead(data, L3G4200D_MEMS_I2C_ADDRESS, L3G4200D_OUT_X_L, 6);
}
...
u8_t L3G4200D_ReadReg(u8_t Reg, u8_t* Data) {
  ...
  //i.e.: *Data = SPI_Mems_Read_Reg( Reg );
	if(!I2C_BufferRead(Data, L3G4200D_MEMS_I2C_ADDRESS, Reg, 1))
		return MEMS_ERROR;
	else
		return MEMS_SUCCESS;
...
u8_t L3G4200D_WriteReg(u8_t Reg, u8_t Data) {
  ...
  //i.e.: SPI_Mems_Write_Reg(Reg, Data);
	I2C_ByteWrite(Data,  L3G4200D_MEMS_I2C_ADDRESS,  Reg);
